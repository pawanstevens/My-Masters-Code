//In this program I have taken diagonal between Charlotte and Orlando.
// So, the 1st triangle will be formed by Charlotte,Atlanta and Orlando.
// The 2nd triangle will be formed by Charlotte, Savannah and Orlando.

class Edition12C4E3EstimateAreas1 
{
	public static void main(String[] args) 
	{
		...
		double cha_lat,atl_lat,orl_lat,sav_lat,cha_long,atl_long,orl_long,sav_long,area1,area2,area,s1,s2,distanceBtwCharAndAtl,distanceBtwOrlAndSav,distanceBtwAtlAndOrl,distanceBtwSavAndChar,distanceBtwChaAndOrl;
		...
		distanceBtwChaAndOrl = 6371.01 * Math.acos(Math.sin(cha_lat) * Math.sin(orl_lat) + Math.cos(cha_lat) * Math.cos(orl_lat) * Math.cos(cha_long - orl_long));
		...
		System.out.println("The distance between Charlotte and Orlando is: " + distanceBtwChaAndOrl + "Km\n");
		
		s1 = (distanceBtwCharAndAtl + distanceBtwChaAndOrl + distanceBtwAtlAndOrl )/2;
		area1 = Math.pow((s1*(s1 - distanceBtwCharAndAtl )*(s1 - distanceBtwChaAndOrl)*(s1 - distanceBtwAtlAndOrl)), 0.5);
		System.out.println("The area of the triangle formed by Charlotte,Atlanta and Orlando is: " + area1 + "Km\u00B2");
		
		s2 = (distanceBtwChaAndOrl + distanceBtwSavAndChar  + distanceBtwOrlAndSav)/2;
		area2 = Math.pow((s2 *(s2 - distanceBtwChaAndOrl)*(s2 - distanceBtwSavAndChar)*(s2 - distanceBtwOrlAndSav)), 0.5);
		System.out.println("The area of the triangle formed by Charlotte,Savannah and Orlando is: " + area2 + "Km\u00B2 \n");
        area = area1 + area2;
